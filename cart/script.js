...
async function getLocationData() {
  try {
    const response = await fetch("/BaiTapFrontEnd/checkout/diaGioiHanhChinhVN.json");
...
document.addEventListener("DOMContentLoaded", async function () {
  ...
  if (buyNowButton) {
    buyNowButton.addEventListener("click", function () {
      ...
      hideLoader();
      window.location.href = "/BaiTapFrontEnd/checkout/thanhToan.html";
    });
  }
  ...
  if (document.getElementById("cartItems")) {
    ...
    buyButton.addEventListener("click", async function () {
      ...
      if (!isLoggedIn) {
        ...
        window.location.href = "/BaiTapFrontEnd/authenticator/login.html"; // Chuyển hướng đến trang đăng nhập
        return;
      }
  ...
  if (document.getElementById("DSSP-checkout")) {
    ...
    placeOrderButton.addEventListener("click", async function () {
      ...
      hideLoader();
      window.location.href = "/BaiTapFrontEnd/checkout/thanhCong.html";
    });
  }
