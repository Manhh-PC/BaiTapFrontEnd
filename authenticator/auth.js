document.addEventListener("DOMContentLoaded", async function () {
  ...
  try {
    ...
    if (user && user.id) {
      ...
      if (window.location.pathname.includes("/authenticator/login.html")) {
        hideLoader();
        window.location.replace("/index.html");
        return;
      }

      if (window.location.pathname.includes("/authenticator/signUp.html")) {
        hideLoader();
        window.location.replace("/index.html");
        return;
      }
      ...
      if (
        window.location.pathname.includes("/account/admin.html") &&
        user.role !== "admin"
      ) {
        hideLoader();
        window.location.replace("index.html");
      ...
      dangNhapDiv.innerHTML = `
            ...
            <a href="/account/account.html" class="logIna">
      ...
      if (adminAccountInfo) {
        if (user.role === "admin") {
          adminAccountInfo.innerHTML = `
                <img src="/img/full logo.jpeg" alt="" class="" />
                ...
                <button class="nutDangXuat">
                  <a href="/account/admin.html">Trang admin</a>
                </button>
      ...
      if (window.location.pathname.includes("/account/admin.html")) {
        hideLoader();
        window.location.replace("/authenticator/login.html");
        return;
      }
      dangNhapDiv.innerHTML = `
        <img src="/img/logo.jpeg" alt="Logo" class = "loGo"/>
        <a href="/authenticator/login.html" class="logIna">
          <div class="dangNhap1" style="margin-right: 10px">
            <i class="fa-regular fa-user"></i>
            <p>Đăng nhập</p>
          </div></a
